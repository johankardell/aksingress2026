...
If the hubless `aks-ingress-demo-fleet` from Demo 06 already exists, `deploy-infra.sh` also joins this AKS cluster as a Fleet member. Membership is optional and does not change AGC or ingress traffic.
